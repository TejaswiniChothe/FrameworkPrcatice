...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		...
		highlightElemet(element);
		return element;
		
	}
	private void highlightElemet(WebElement element)
	{
...
@Step("Checking element Presence : {0}")
	...
	@Step("wait For Wbelement Visiblity :{0} within timout {1} ")
	...
	public String waitforTitleIs(String exactTitle, long timeout) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
		try {
